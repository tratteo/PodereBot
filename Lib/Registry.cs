...
internal static class Registry
{
    public static readonly List<CommandRegistryKey> commands =
        [
        new CommandRegistryKey<OpenAutomaticGateCommand>("/openauto","Apri il cancello automatico"),
    ...
    new CommandRegistryKey<UnlockGatesCommand>("/gates", "Abilita o disabilita l'apertura dei cancelli a tuti gli utenti",admin:true)];
}